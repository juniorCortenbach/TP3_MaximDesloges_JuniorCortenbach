...
namespace tp3
{
    ...
    public class BitmapMatricielle
    {
        ...
        public void Colonnes()
        {
            ...
            //{
            //    //Pour chaque colonne.
            //    for (int y = 0; y < this.Hauteur; y = y + 2)
            //    {
            //        if (x != 0)
            //            this[y, x] = imgTempo[y, x / 2];
            //    }
            //}
            ...
            //{
            //    //Pour chaque colonne.
            //    for (int y = 1; y < this.Hauteur; y = y + 2)
            //    {
            //        this[y, x] = imgTempo[y, (this.Largeur / 2) + (x - 1) / 2];
            //    }
            //}
        }
        ...
        public void Boulanger()
        {
            ...
            //Affecte la couleur du dernier pixel en largeur à la dernière position en largeur*2
            //seulement sur la moitié des pixels.
            for (int y = 0; y < this.Hauteur; y++)
            {
                int i = 0;

                for (int x = 0; x < this.Largeur; x = x + 2)
                {
                    tabPixels[x, y] = this[i, y];
                    //this[x,y] = tabTempo[x, y];
                    i++;
                }
            }
            ...
            //Place le pixel de la colonne inférieur sur la rangée inférieur
            //dans les pixels vides.
            //for (int y = 0; y < this.Hauteur; y++)
            //{
            //    for (int x = 1; x < this.Largeur; x = x + 2)
            //    {
            //        tabPixels[x, y] = tabPixels[x - 1, y - 1];
            //        //this[x,y] = tabTempo[x, y];
